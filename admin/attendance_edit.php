                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" method="post" action="attendance_edit_validation.php">                                                                        
								   <table>                                   
								   <tr>
								   <td><?php echo $_REQUEST['roll']; ?></td>								   
								   <input type="hidden" name="id" value="<?php echo $_REQUEST['id']; ?>" >								   
								   <td id="check"><input type="checkbox" name="status[]" value="Present" >Present</td>
								   <td id="check"><input type="checkbox" name="status[]" value="Absent" >Absent</td>
								   </tr>								   
