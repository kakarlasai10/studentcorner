...
$insert='insert into `faculty`(faculty_name,father_name,dob,phone,emailid,username,password,ppassword,gender,dept,designation,high_qualification,doj,pay_scale,exp,fac_photo,Address) 
values(
"'.$_POST['faculty_name'].'",
"'.$_POST['father_name'].'",
"'.$_POST['dob'].'",
