...
$select="select student.*,suggessiontbl.* from student RIGHT JOIN suggessiontbl ON student.rollno=suggessiontbl.rollno_no where sugg_id = '$_POST[id]'";
$query=mysql_query($select);
$fetch=mysql_fetch_array($query);
$_SESSION['suggg_id']=$_POST['id'];
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Zoom4Web student Suggessions</title>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal " method="post" action="form_suggession_validation.php">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Roll No</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="roll" value="<?php echo $fetch['rollno_no']; ?>">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Student Name</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="name" value="<?php echo $fetch['stud_name']; ?>">     
                                      </div>
                                  </div>
                                 <div class="form-group">
                                      <label class="col-sm-2 control-label">Suggession</label>
                                      <div class="col-sm-10">
                                          <textarea  class="form-control" name="message"  rows="10" cols="20"> <?php echo $fetch['message']; ?>
                                           </textarea>										  
                                      </div>
                                  </div>
                                   <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <textarea  class="form-control" name="reply"  rows="10" cols="20"  required> 
                                           </textarea>										  
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <div class="col-sm-10">
                                          <input type="submit" name="send" value="SEND" style="margin-left:200px;">     
                                      </div>
                                  </div>
                      ...
                      <div class="row">
                          <div class="col-lg-6">
                              ...
                              <section class="panel">
                                  ...
                                  <div class="panel-body">
                                      <input name="tagsinput" id="tagsinput" class="tagsinput" value="Karmanta, Dashboard, Admin, Template, Theme, Bootstrap, Responsive, Retina, Minimal" />
                                  </div>
                              </section>
                          </div>
                          <div class="col-lg-6">
