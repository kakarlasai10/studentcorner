...
<html lang="en">
  <head>
    ...
    <title>Zoom4Web attendance</title>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" method="post" action="student_attendence.php">
								<table>  
                                   <?php while($fetch=mysql_fetch_array($query)){ ?>
								   <tr>
								   <td><?php echo $fetch['rollno']; ?></td>
								   <input type="hidden" name="rollno<?php echo $i; ?>" value="<?php echo $fetch['rollno']; ?>" >
								   <input type="hidden" name="depart" value="<?php echo $_POST['depart']; ?>" >
								   <input type="hidden" name="section" value="<?php echo $_POST['section']; ?>" >
								   <input type="hidden" name="subjects" value="<?php echo $_POST['subjects']; ?>" >
								   <td id="check"><input type="checkbox" name="status<?php echo $i; ?>[]" value="Present" >Present</td>
								   <td id="check"><input type="checkbox" name="status<?php echo $i; ?>[]" value="Absent" >Absent</td>
								   </tr>
								   <?php $i++; } ?>
								   <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                           <tr><td><input type="submit" class="btn btn-primary" value="Submit" name="submit" ></td></tr>											  
                                          </div>
                                      </div>
									  </table>
                                  </form>
