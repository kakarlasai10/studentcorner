                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" method="post" action="marks_edit_validation.php">                                                                        
								   <table>                                   
								   <tr>
								   <td><?php echo $_REQUEST['roll']; ?></td>								   
								   <input type="hidden" name="id" value="<?php echo $_REQUEST['id']; ?>" >								   
								   <td id="check"><input type="text" name="marks" value="<?php echo $fetch['sub_marks']; ?>" ></td>								   
								   </tr>								   
